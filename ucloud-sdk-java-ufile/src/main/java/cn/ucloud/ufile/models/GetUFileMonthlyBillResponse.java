...
public class GetUFileMonthlyBillResponse extends Response {

    /** 消费情况 */
    @SerializedName("DataSet")
    private List<BucketMonthlyBills> dataSet;

    public List<BucketMonthlyBills> getDataSet() {
        return dataSet;
    }

    public void setDataSet(List<BucketMonthlyBills> dataSet) {
    ...
    public static class BucketMonthlyBills extends Response {

        /** bucket账单 */
        @SerializedName("BucketBills")
        private List<UFileMonthlyBillItem> bucketBills;

        public List<UFileMonthlyBillItem> getBucketBills() {
            return bucketBills;
        }

        public void setBucketBills(List<UFileMonthlyBillItem> bucketBills) {
            this.bucketBills = bucketBills;
        }
    }

    public static class UFileMonthlyBillItem extends Response {
