...
public class CreateAsyncVideoTaskParam extends BaseRestRequestParam {
    ...
    public CreateAsyncVideoTaskParam(@NotEmpty(message = "resourceId can not be empty") String resourceId,
