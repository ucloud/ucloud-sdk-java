...
public class ListUBillDetailRequest extends Request {
    ...
    /**
     * 订单类型 (筛选项, 默认全部) 。枚举值：\\ > OT_BUY:新购 \\ > OT_RENEW:续费 \\ > OT_UPGRADE:升级 \\ > OT_REFUND:退费 \\
     * > OT_DOWNGRADE:降级 \\ > OT_SUSPEND:结算 \\ > OT_PAYMENT:删除资源回款 \\ > OT_POSTPAID_PAYMENT:后付费回款 \\
     * > OT_RECOVER:删除恢复 \\ > OT_POSTPAID_RENEW:过期续费回款
     */
    @UCloudParam("OrderType")
    private String orderType;

    /**
     * 计费方式 (筛选项, 默认全部)。枚举值：\\ > Dynamic:按时 \\ > Month:按月 \\ > Year:按年 \\ > Once:一次性按量 \\ > Used:按量
     * \\ > Post:后付费
     */
