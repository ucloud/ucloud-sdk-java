...
public class GetUSMSSendReceiptRequest extends Request {
    ...
    /** 发送短信时返回的SessionNo集合，SessionNoSet.0,SessionNoSet.1....格式，单次调用集合数需控制在100个以内: false */
    @NotEmpty
    @UCloudParam("SessionNoSet")
