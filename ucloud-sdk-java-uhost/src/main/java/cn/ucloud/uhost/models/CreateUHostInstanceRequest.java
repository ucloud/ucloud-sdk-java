...
public class CreateUHostInstanceRequest extends Request {
    ...
    /** 镜像ID。 请通过 [DescribeImage](describe_image.html)获取: false */
    @NotEmpty
    @UCloudParam("ImageId")
    ...
    /** 主机登陆模式。密码（默认选项）: Password，密钥：KeyPair。: false */
    @NotEmpty
     ...
     * | base64UGFzc3dvcmQx。: false
     */
    @UCloudParam("Password")
    private String password;

    /** UHost实例名称。默认：UHost。请遵照[[api:uhost-api:specification|字段规范]]设定实例名称。: false */
    @UCloudParam("Name")
    private String name;

    /** 业务组。默认：Default（Default即为未分组）。请遵照[[api:uhost-api:specification|字段规范]]设定业务组。: false */
    @UCloudParam("Tag")
    private String tag;

    /**
     * 计费模式。枚举值为： \\ > Year，按年付费； \\ > Month，按月付费；\\ > Dynamic，按小时预付费 \\ >
     * Postpay，按小时后付费（支持关机不收费，目前仅部分可用区支持，请联系您的客户经理） \\Preemptive计费为抢占式实例(内测阶段) \\ 默认为月付 : false
     */
    @UCloudParam("ChargeType")
    private String chargeType;

    /** 购买时长。默认:值 1。按小时购买（Dynamic/Postpay）时无需此参数。 月付时，此参数传0，代表购买至月末。: false */
    ...
    /** 虚拟CPU核数。可选参数：1-64（具体机型与CPU的对应关系参照控制台）。默认值: 4。: false */
    @UCloudParam("CPU")
    private Integer cpu;

    /** 内存大小。单位：MB。范围 ：[1024, 262144]，取值为1024的倍数（可选范围参考控制台）。默认值：8192: false */
    @UCloudParam("Memory")
    private Integer memory;

    /**
     * GPU类型，枚举值["K80", "P40", "V100", "T4", "T4S","2080Ti","2080Ti-4C","1080Ti", "T4/4", "MI100",
     * "V100S"]，MachineType为G时必填: false
     */
    @UCloudParam("GpuType")
    ...
    /** 网络增强特性。枚举值：Normal（默认），不开启; Super，开启网络增强1.0； Ultra，开启网络增强2.0（仅支持部分可用区，请参考控制台）: false */
    @UCloudParam("NetCapability")
    private String netCapability;

    /** 热升级特性。True为开启，False为未开启，默认False。: false */
    @UCloudParam("HotplugFeature")
    private Boolean hotplugFeature;

    /** VPC ID。默认为当前地域的默认VPC。: false */
    @UCloudParam("VPCId")
    private String vpcId;

    /** 子网 ID。默认为当前地域的默认子网。: false */
    @UCloudParam("SubnetId")
    private String subnetId;

    /** 【数组】创建云主机时指定内网IP。若不传值，则随机分配当前子网下的IP。调用方式举例：PrivateIp.0=x.x.x.x。当前只支持一个内网IP。: false */
    ...
    /** 告警模板id，如果传了告警模板id，且告警模板id正确，则绑定告警模板。绑定告警模板失败只会在后台有日志，不会影响创建主机流程，也不会在前端报错。: false */
     ...
     * "O.BM", "O.EPC"]。参考[[api:uhost-api:uhost_type|云主机机型说明]]。: false
     */
     ...
     * "Amd/Auto"],默认值是"Intel/Auto"。: false
     */
    @UCloudParam("MinimalCpuPlatform")
    private String minimalCpuPlatform;

    /** 本次最大创建主机数量，取值范围是[1,100]，默认值为1。: false */
    ...
    /** 数据盘是否需要自动分区挂载。当镜像支持“Cloud-init”Feature时可填写此字段。取值 >“On” 自动挂载（默认值）> “Off” 不自动挂载。: false */
    ...
    /** KeypairId 密钥对ID，LoginMode为KeyPair时此项必须: false */
    ...
    /** 主机代金券ID。请通过DescribeCoupon接口查询，或登录用户中心查看: false */
    ...
    public static class NetworkInterfaceEIP extends Request {
         ...
         * "Free":免费带宽模式,默认为 "Bandwidth": false
         */
        @UCloudParam("PayMode")
         ...
         * sg:International tw-kh:International.其他海外线路均为 International: false
         */
        @UCloudParam("OperatorName")
        private String operatorName;

        /** 当前EIP代金券id。请通过DescribeCoupon接口查询，或登录用户中心查看。: false */
        @UCloudParam("CouponId")
        private String couponId;
    ...
    public static class Features extends Request {
        ...
        /** 弹性网卡特性。开启了弹性网卡权限位，此特性才生效，默认 false 未开启，true 开启，仅与 NetCapability Normal 兼容。: false */
        @UCloudParam("UNI")
        private Boolean uni;
    ...
    public static class NetworkInterface extends Request {
        ...
        /** 申请并绑定一个教育网EIP。True为申请并绑定，False为不会申请绑定，默认False。当前只支持具有HPC特性的机型。: false */
    ...
    public static class NetworkInterfaceEIPGlobalSSH extends Request {
        ...
        /** 填写支持SSH访问IP的地区名称，如“洛杉矶”，“新加坡”，“香港”，“东京”，“华盛顿”，“法兰克福”。Area和AreaCode两者必填其中之一。: false */
        @UCloudParam("Area")
        private String area;

        /** SSH端口，1-65535且不能使用80，443端口: false */
        @UCloudParam("Port")
        private Integer port;

        /** GlobalSSH的地区编码，格式为区域航空港国际通用代码。Area和AreaCode两者必填其中之一。: false */
    ...
    public static class Disks extends Request {
        ...
        /** 磁盘大小，单位GB，必须是10GB的整数倍。请参考[[api:uhost-api:disk_type|磁盘类型]]。: false */
        @NotEmpty
        @UCloudParam("Size")
         ...
         * \\当前磁盘支持的备份模式参考 [[api:uhost-api:disk_type|磁盘类型]],默认值:NONE: false
         */
        @UCloudParam("BackupType")
        private String backupType;

        /** 【功能仅部分可用区开放，详询技术支持】磁盘是否加密。加密：true, 不加密: false 加密必须传入对应的的KmsKeyId,默认值false: false */
        @UCloudParam("Encrypted")
        private Boolean encrypted;

        /** 【功能仅部分可用区开放，详询技术支持】kms key id。选择加密盘时必填。: false */
        @UCloudParam("KmsKeyId")
        private String kmsKeyId;

        /** 云盘代金券id。不适用于系统盘/本地盘。请通过DescribeCoupon接口查询，或登录用户中心查看: false */
        @UCloudParam("CouponId")
        private String couponId;
