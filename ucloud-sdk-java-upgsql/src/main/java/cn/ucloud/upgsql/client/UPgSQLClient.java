...
public class UPgSQLClient extends DefaultClient implements UPgSQLClientInterface {
    public UPgSQLClient(Config config, Credential credential) {
         ...
         */
        public BackupUPgSQLLogResponse backupUPgSQLLog(BackupUPgSQLLogRequest request) throws UCloudException {
         ...
         * @throws UCloudException Exception
         */
        public CreateUPgSQLInstanceResponse createUPgSQLInstance(CreateUPgSQLInstanceRequest request) throws UCloudException {
            request.setAction("CreateUPgSQLInstance");
            return (CreateUPgSQLInstanceResponse) this.invoke(request, CreateUPgSQLInstanceResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public CreateUPgSQLParamTemplateResponse createUPgSQLParamTemplate(CreateUPgSQLParamTemplateRequest request) throws UCloudException {
            request.setAction("CreateUPgSQLParamTemplate");
            return (CreateUPgSQLParamTemplateResponse) this.invoke(request, CreateUPgSQLParamTemplateResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public CreateUPgSQLReadonlyResponse createUPgSQLReadonly(CreateUPgSQLReadonlyRequest request) throws UCloudException {
            request.setAction("CreateUPgSQLReadonly");
            return (CreateUPgSQLReadonlyResponse) this.invoke(request, CreateUPgSQLReadonlyResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public DeleteUPgSQLInstanceResponse deleteUPgSQLInstance(DeleteUPgSQLInstanceRequest request) throws UCloudException {
            request.setAction("DeleteUPgSQLInstance");
            return (DeleteUPgSQLInstanceResponse) this.invoke(request, DeleteUPgSQLInstanceResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public DeleteUPgSQLParamTemplateResponse deleteUPgSQLParamTemplate(DeleteUPgSQLParamTemplateRequest request) throws UCloudException {
            request.setAction("DeleteUPgSQLParamTemplate");
            return (DeleteUPgSQLParamTemplateResponse) this.invoke(request, DeleteUPgSQLParamTemplateResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public DownloadUPgSQLParamTemplateResponse downloadUPgSQLParamTemplate(DownloadUPgSQLParamTemplateRequest request) throws UCloudException {
            request.setAction("DownloadUPgSQLParamTemplate");
            return (DownloadUPgSQLParamTemplateResponse) this.invoke(request, DownloadUPgSQLParamTemplateResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public GetUPgSQLBackupStrategyResponse getUPgSQLBackupStrategy(GetUPgSQLBackupStrategyRequest request) throws UCloudException {
            request.setAction("GetUPgSQLBackupStrategy");
            return (GetUPgSQLBackupStrategyResponse) this.invoke(request, GetUPgSQLBackupStrategyResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public GetUPgSQLBackupURLResponse getUPgSQLBackupURL(GetUPgSQLBackupURLRequest request) throws UCloudException {
         ...
         * @throws UCloudException Exception
         */
        public GetUPgSQLInstanceResponse getUPgSQLInstance(GetUPgSQLInstanceRequest request) throws UCloudException {
         ...
         * @throws UCloudException Exception
         */
        public GetUPgSQLInstanceLogResponse getUPgSQLInstanceLog(GetUPgSQLInstanceLogRequest request) throws UCloudException {
            request.setAction("GetUPgSQLInstanceLog");
            return (GetUPgSQLInstanceLogResponse) this.invoke(request, GetUPgSQLInstanceLogResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public GetUPgSQLInstancePriceResponse getUPgSQLInstancePrice(GetUPgSQLInstancePriceRequest request) throws UCloudException {
            request.setAction("GetUPgSQLInstancePrice");
            return (GetUPgSQLInstancePriceResponse) this.invoke(request, GetUPgSQLInstancePriceResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public GetUPgSQLParamTemplateResponse getUPgSQLParamTemplate(GetUPgSQLParamTemplateRequest request) throws UCloudException {
            request.setAction("GetUPgSQLParamTemplate");
            return (GetUPgSQLParamTemplateResponse) this.invoke(request, GetUPgSQLParamTemplateResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public GetUPgSQLUpgradePriceResponse getUPgSQLUpgradePrice(GetUPgSQLUpgradePriceRequest request) throws UCloudException {
            request.setAction("GetUPgSQLUpgradePrice");
            return (GetUPgSQLUpgradePriceResponse) this.invoke(request, GetUPgSQLUpgradePriceResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public ListUPgSQLBackupResponse listUPgSQLBackup(ListUPgSQLBackupRequest request) throws UCloudException {
         ...
         * @throws UCloudException Exception
         */
        public ListUPgSQLInstanceResponse listUPgSQLInstance(ListUPgSQLInstanceRequest request) throws UCloudException {
         ...
         * @throws UCloudException Exception
         */
        public ListUPgSQLMachineTypeResponse listUPgSQLMachineType(ListUPgSQLMachineTypeRequest request) throws UCloudException {
         ...
         * @throws UCloudException Exception
         */
        public ListUPgSQLVersionResponse listUPgSQLVersion(ListUPgSQLVersionRequest request) throws UCloudException {
         ...
         * @throws UCloudException Exception
         */
        public RestartUPgSQLInstanceResponse restartUPgSQLInstance(RestartUPgSQLInstanceRequest request) throws UCloudException {
            request.setAction("RestartUPgSQLInstance");
            return (RestartUPgSQLInstanceResponse) this.invoke(request, RestartUPgSQLInstanceResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public StartUPgSQLInstanceResponse startUPgSQLInstance(StartUPgSQLInstanceRequest request) throws UCloudException {
            request.setAction("StartUPgSQLInstance");
            return (StartUPgSQLInstanceResponse) this.invoke(request, StartUPgSQLInstanceResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public StopUPgSQLCreatingReadonlyResponse stopUPgSQLCreatingReadonly(StopUPgSQLCreatingReadonlyRequest request) throws UCloudException {
            request.setAction("StopUPgSQLCreatingReadonly");
            return (StopUPgSQLCreatingReadonlyResponse) this.invoke(request, StopUPgSQLCreatingReadonlyResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public StopUPgSQLInstanceResponse stopUPgSQLInstance(StopUPgSQLInstanceRequest request) throws UCloudException {
         ...
         * @throws UCloudException Exception
         */
        public UpdateUPgSQLAttributeResponse updateUPgSQLAttribute(UpdateUPgSQLAttributeRequest request) throws UCloudException {
            request.setAction("UpdateUPgSQLAttribute");
            return (UpdateUPgSQLAttributeResponse) this.invoke(request, UpdateUPgSQLAttributeResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public UpdateUPgSQLBackupStrategyResponse updateUPgSQLBackupStrategy(UpdateUPgSQLBackupStrategyRequest request) throws UCloudException {
            request.setAction("UpdateUPgSQLBackupStrategy");
            return (UpdateUPgSQLBackupStrategyResponse) this.invoke(request, UpdateUPgSQLBackupStrategyResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public UpdateUPgSQLPasswordResponse updateUPgSQLPassword(UpdateUPgSQLPasswordRequest request) throws UCloudException {
            request.setAction("UpdateUPgSQLPassword");
            return (UpdateUPgSQLPasswordResponse) this.invoke(request, UpdateUPgSQLPasswordResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public UpgradeUPgSQLInstanceResponse upgradeUPgSQLInstance(UpgradeUPgSQLInstanceRequest request) throws UCloudException {
            request.setAction("UpgradeUPgSQLInstance");
            return (UpgradeUPgSQLInstanceResponse) this.invoke(request, UpgradeUPgSQLInstanceResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public UploadUPgSQLParamTemplateResponse uploadUPgSQLParamTemplate(UploadUPgSQLParamTemplateRequest request) throws UCloudException {
            request.setAction("UploadUPgSQLParamTemplate");
            return (UploadUPgSQLParamTemplateResponse) this.invoke(request, UploadUPgSQLParamTemplateResponse.class);
        }
}
