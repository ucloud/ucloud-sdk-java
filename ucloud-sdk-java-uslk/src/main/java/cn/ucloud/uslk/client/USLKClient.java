...
public class USLKClient extends DefaultClient implements USLKClientInterface {
     ...
     */
    public BatchCreateUSLKShortLinkResponse batchCreateUSLKShortLink(
            BatchCreateUSLKShortLinkRequest request) throws UCloudException {
        request.setAction("BatchCreateUSLKShortLink");
        return (BatchCreateUSLKShortLinkResponse)
                this.invoke(request, BatchCreateUSLKShortLinkResponse.class);
    }
     ...
     * @throws UCloudException Exception
     */
    public CreateUSLKLongLinkResponse createUSLKLongLink(CreateUSLKLongLinkRequest request)
     ...
     * @throws UCloudException Exception
     */
    public CreateUSLKScenarioResponse createUSLKScenario(CreateUSLKScenarioRequest request)
            throws UCloudException {
     ...
     * @throws UCloudException Exception
     */
    public CreateUSLKShortLinkResponse createUSLKShortLink(CreateUSLKShortLinkRequest request)
            throws UCloudException {
        request.setAction("CreateUSLKShortLink");
        return (CreateUSLKShortLinkResponse)
                this.invoke(request, CreateUSLKShortLinkResponse.class);
    }
     ...
     * @throws UCloudException Exception
     */
    public DescribeUSLKRedirectRecordsResponse describeUSLKRedirectRecords(
            DescribeUSLKRedirectRecordsRequest request) throws UCloudException {
        request.setAction("DescribeUSLKRedirectRecords");
        return (DescribeUSLKRedirectRecordsResponse)
                this.invoke(request, DescribeUSLKRedirectRecordsResponse.class);
    }
     ...
     * @throws UCloudException Exception
     */
    public DescribeUSLKShortLinkListResponse describeUSLKShortLinkList(
            DescribeUSLKShortLinkListRequest request) throws UCloudException {
        request.setAction("DescribeUSLKShortLinkList");
        return (DescribeUSLKShortLinkListResponse)
                this.invoke(request, DescribeUSLKShortLinkListResponse.class);
    }
}
