...
/**
 * @description: 修改主机名 参数类
 * @author: codezhang
 * @date: 2018-09-18 13:02
 **/

public class ModifyUHostInstanceNameParam extends BaseRequestParam {
    ...
    public ModifyUHostInstanceNameParam(@NotEmpty(message = "region can not be empty") String region,
                                        @NotEmpty(message = "uhostId can not be empty") String uhostId) {
        super("ModifyUHostInstanceName");
        this.region = region;
