...
public class CreateUFileTokenResponse extends Response {
     ...
     * 创建令牌的详细信息
     */
    @SerializedName("UFileTokenSet")
    private UFileTokenSet uFileTokenSet;
    ...
    public UFileTokenSet getUFileTokenSet() {
        return uFileTokenSet;
    }

    public void setUFileTokenSet(UFileTokenSet uFileTokenSet) {
        this.uFileTokenSet = uFileTokenSet;
    }
