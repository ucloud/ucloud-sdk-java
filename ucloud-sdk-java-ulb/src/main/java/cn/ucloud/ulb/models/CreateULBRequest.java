...
public class CreateULBRequest extends Request {
    ...
    /** 付费方式, 枚举值为: Year, 按年付费; Month, 按月付费; Dynamic, 按时付费: false */
    @UCloudParam("ChargeType")
    private String chargeType;

    /** ULB所在的VPC的ID, 如果不传则使用默认的VPC: false */
    @UCloudParam("VPCId")
    private String vpcId;

    /** ULB 所属的子网ID，如果不传则随机选择一个。: false */
    @UCloudParam("SubnetId")
    private String subnetId;

    /** ULB 所属的业务组ID，如果不传则使用默认的业务组: false */
    @UCloudParam("BusinessId")
    private String businessId;

    /** 防火墙ID，如果不传，则默认不绑定防火墙: false */
