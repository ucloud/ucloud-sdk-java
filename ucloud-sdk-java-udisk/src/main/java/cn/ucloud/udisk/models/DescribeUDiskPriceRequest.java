...
public class DescribeUDiskPriceRequest extends Request {
    ...
    /** Year , Month, Dynamic，Postpay，Trial 默认: Month: false */
    @UCloudParam("ChargeType")
    private String chargeType;

    /** 购买UDisk的时长，默认值为1: false */
    ...
    /** 是否将快照服务(数据方舟)，云硬盘放入一张订单, 是："Yes",否："No"，默认是"No": false */
    @UCloudParam("IsTotalPrice")
    private String isTotalPrice;

    /** 云主机机型（V2.0），枚举值["N", "C", "G", "O", "OM"]。参考[[api:uhost-api:uhost_type|云主机机型说明]]。: false */
