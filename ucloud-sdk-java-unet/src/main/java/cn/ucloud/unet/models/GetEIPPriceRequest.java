...
public class GetEIPPriceRequest extends Request {
     ...
     * tw-kh:International.其他海外线路均为 International,泉州为移动单线cn-qz:ChinaMobile: false
     */
    @NotEmpty
    @UCloudParam("OperatorName")
    private String operatorName;

    /** 弹性IP的外网带宽, 单位为Mbps, 范围 [0-800]: false */
    @NotEmpty
    @UCloudParam("Bandwidth")
    private Integer bandwidth;

    /** 付费方式, 枚举值为: Year, 按年付费; Month, 按月付费; Dynamic, 按时付费; 默认为获取三种价格: false */
    @UCloudParam("ChargeType")
    private String chargeType;

    /**
     * 弹性IP计费方式r. 枚举值为: Traffic, 流量计费; Bandwidth, 带宽计费; "ShareBandwidth",共享带宽模式. 默认为Bandwidth: false
     */
    @UCloudParam("PayMode")
