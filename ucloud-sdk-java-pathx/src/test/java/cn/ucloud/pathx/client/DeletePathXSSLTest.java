...
public class DeletePathXSSLTest {
    ...
    @Test
    public void deletePathXSSLCallback() {
        client.deletePathXSSL(param, new UcloudHandler
                <DeletePathXSSLResult>() {
            @Override
            public Object success(DeletePathXSSLResult result) {
                JSONComparator.jsonComparator(result);
                return null;
            }

            @Override
            public Object failed(DeletePathXSSLResult result) {
                JSONComparator.jsonComparator(result);
                return null;
            }
