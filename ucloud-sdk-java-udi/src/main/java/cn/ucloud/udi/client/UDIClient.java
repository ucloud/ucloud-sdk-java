...
public class UDIClient extends DefaultClient implements UDIClientInterface {
    public UDIClient(Config config, Credential credential) {
        ...
        public CreateFunctionTemplateResponse createFunctionTemplate(CreateFunctionTemplateRequest request) throws UCloudException {
            ...
            return (CreateFunctionTemplateResponse) this.invoke(request, CreateFunctionTemplateResponse.class);
        }
        ...
        public DeleteFunctionTemplateResponse deleteFunctionTemplate(DeleteFunctionTemplateRequest request) throws UCloudException {
            ...
            return (DeleteFunctionTemplateResponse) this.invoke(request, DeleteFunctionTemplateResponse.class);
        }
        ...
        public DescribeFunctionTemplateResponse describeFunctionTemplate(DescribeFunctionTemplateRequest request) throws UCloudException {
            ...
            return (DescribeFunctionTemplateResponse) this.invoke(request, DescribeFunctionTemplateResponse.class);
        }
        ...
        public DescribeMediaFunctionsResponse describeMediaFunctions(DescribeMediaFunctionsRequest request) throws UCloudException {
            ...
            return (DescribeMediaFunctionsResponse) this.invoke(request, DescribeMediaFunctionsResponse.class);
        }
