...
public class UMongoDBClient extends DefaultClient implements UMongoDBClientInterface {
    public UMongoDBClient(Config config, Credential credential) {
         ...
         * @throws UCloudException Exception
         */
        public CreateUMongoDBReplSetResponse createUMongoDBReplSet(CreateUMongoDBReplSetRequest request) throws UCloudException {
            request.setAction("CreateUMongoDBReplSet");
            return (CreateUMongoDBReplSetResponse) this.invoke(request, CreateUMongoDBReplSetResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public CreateUMongoDBShardedClusterResponse createUMongoDBShardedCluster(CreateUMongoDBShardedClusterRequest request) throws UCloudException {
            request.setAction("CreateUMongoDBShardedCluster");
            return (CreateUMongoDBShardedClusterResponse) this.invoke(request, CreateUMongoDBShardedClusterResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public DescribeUMongoDBInstanceResponse describeUMongoDBInstance(DescribeUMongoDBInstanceRequest request) throws UCloudException {
            request.setAction("DescribeUMongoDBInstance");
            return (DescribeUMongoDBInstanceResponse) this.invoke(request, DescribeUMongoDBInstanceResponse.class);
        }
