...
public class AddTargetsRequest extends Request {
    ...
    public static class Targets extends Request {
        ...
        /**
         * 服务节点的类型。限定枚举值："UHost" /
         * "UNI"/"UPM"/"IP"，默认值："UHost"；非IP类型，如果该资源有多个IP，将只能添加主IP；非IP类型，展示时，会显示相关资源信息，IP类型只展示IP信息。在相关资源被删除时，非IP类型会把相关资源从lb中剔除，IP类型不保证这个逻辑
         */
