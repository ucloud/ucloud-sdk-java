...
public class DelUK8SClusterNodeV2Request extends Request {
    ...
    /** 项目ID项目ID。不填写为默认项目，子帐号必须填写。 请参考[GetProjectList接口](../summary/get_project_list.html): false */
    ...
    /** Node在UK8S处的唯一标示，如uk8s-reewqe5-sdasadsda。**非云主机或物理云主机资源Id**: false */
    @NotEmpty
    @UCloudParam("NodeId")
    private String nodeId;

    /** 删除节点时是否释放数据盘。 枚举值[true:释放，false: 不释放]，默认为true。: false */
