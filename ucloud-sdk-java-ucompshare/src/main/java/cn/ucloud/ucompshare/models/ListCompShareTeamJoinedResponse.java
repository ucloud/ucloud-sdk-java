...
public class ListCompShareTeamJoinedResponse extends Response {

    /** 加入团队信息数组 */
    @SerializedName("JoinedTeams")
    private List<CompShareTeamJoinedInfo> joinedTeams;

    public List<CompShareTeamJoinedInfo> getJoinedTeams() {
        return joinedTeams;
    }

    public void setJoinedTeams(List<CompShareTeamJoinedInfo> joinedTeams) {
        this.joinedTeams = joinedTeams;
    }

    public static class CompShareTeamJoinedInfo extends Response {
        ...
        /** 当前是否为个人账号 */
        @SerializedName("IsPersonalAccount")
        ...
        public Boolean getIsPersonalAccount() {
            return isPersonalAccount;
        }

        public void setIsPersonalAccount(Boolean isPersonalAccount) {
