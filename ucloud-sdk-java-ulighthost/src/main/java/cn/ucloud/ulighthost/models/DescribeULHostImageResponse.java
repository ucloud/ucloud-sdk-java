...
public class DescribeULHostImageResponse extends Response {
    ...
    private List<ULHostImageSet> imageSet;
    ...
    public List<ULHostImageSet> getImageSet() {
        return imageSet;
    }

    public void setImageSet(List<ULHostImageSet> imageSet) {
        this.imageSet = imageSet;
    }

    public static class ULHostImageSet extends Response {
