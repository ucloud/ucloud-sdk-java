...
public class UCDNClient extends DefaultClient implements UCDNClientInterface {
    public UCDNClient(Config config, Credential credential) {
         ...
         * @throws UCloudException Exception
         */
        public GetUcdnDomainOriginHttpCodeResponse getUcdnDomainOriginHttpCode(GetUcdnDomainOriginHttpCodeRequest request) throws UCloudException {
            request.setAction("GetUcdnDomainOriginHttpCode");
            return (GetUcdnDomainOriginHttpCodeResponse) this.invoke(request, GetUcdnDomainOriginHttpCodeResponse.class);
        }
         ...
         * @throws UCloudException Exception
         */
        public GetUcdnDomainOriginHttpCodeDetailResponse getUcdnDomainOriginHttpCodeDetail(GetUcdnDomainOriginHttpCodeDetailRequest request) throws UCloudException {
            request.setAction("GetUcdnDomainOriginHttpCodeDetail");
            return (GetUcdnDomainOriginHttpCodeDetailResponse) this.invoke(request, GetUcdnDomainOriginHttpCodeDetailResponse.class);
        }
