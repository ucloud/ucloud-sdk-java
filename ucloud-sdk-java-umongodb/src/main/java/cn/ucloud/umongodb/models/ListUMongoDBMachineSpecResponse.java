...
public class ListUMongoDBMachineSpecResponse extends Response {
    ...
    private List<MongodbMachineSpec> dataSet;

    public List<MongodbMachineSpec> getDataSet() {
        return dataSet;
    }

    public void setDataSet(List<MongodbMachineSpec> dataSet) {
    ...
    public static class MongodbMachineSpec extends Response {
        ...
        private List<MongodbMachineType> computeType;
        ...
        public List<MongodbMachineType> getComputeType() {
            return computeType;
        }

        public void setComputeType(List<MongodbMachineType> computeType) {
