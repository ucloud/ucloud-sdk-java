...
import cn.ucloud.ucdn.models.GetUcdnDomainPrefetchRefreshStateRequest;
import cn.ucloud.ucdn.models.GetUcdnDomainPrefetchRefreshStateResponse;
...
public class UCDNClient extends DefaultClient implements UCDNClientInterface {
     ...
     * @throws UCloudException Exception
     */
    public GetAuthConfigResponse getAuthConfig(GetAuthConfigRequest request)
            throws UCloudException {
     ...
     * @throws UCloudException Exception
     */
    public GetUcdnDomainPrefetchRefreshStateResponse getUcdnDomainPrefetchRefreshState(
            GetUcdnDomainPrefetchRefreshStateRequest request) throws UCloudException {
        request.setAction("GetUcdnDomainPrefetchRefreshState");
        return (GetUcdnDomainPrefetchRefreshStateResponse)
                this.invoke(request, GetUcdnDomainPrefetchRefreshStateResponse.class);
    }
