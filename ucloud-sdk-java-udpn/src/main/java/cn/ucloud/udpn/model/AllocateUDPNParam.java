...
/**
 * @description: 分配 UDPN 专线 参数类
 * @author: joshua
 * @E-mail: joshua.yin@ucloud.cn
 * @date: 2019-03-01 16:01
 */
public class AllocateUDPNParam extends BaseRequestParam {
    ...
    public AllocateUDPNParam(@NotEmpty(message = "Peer1 can not be empty") String peer1,
