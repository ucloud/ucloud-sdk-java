...
public class CreateURedisGroupRequest extends Request {
    ...
    /** 是否开启高可用,enable或disable: false */
    @NotEmpty
    @UCloudParam("HighAvailability")
    private String highAvailability;

    /** 每个节点的内存大小,单位GB,默认1GB,目前仅支持1/2/4/8/16/32,六种: false */
    @UCloudParam("Size")
    private Integer size;

    /** 是否自动备份,enable或disable，默认disable: false */
    @UCloudParam("AutoBackup")
    private String autoBackup;

    /** 自动备份开始时间,范围[0-23],默认3点: false */
     ...
     * 4.0版本配置ID:"6c9298a3-9d7f-428c-b1d0-e87ab3b8a1ea",默认版本3.0,从备份创建为必传项: false
     */
    @UCloudParam("ConfigId")
    private String configId;

    /** Redis版本信息(详见DescribeURedisVersion返回结果),默认版本3.0: false */
    @UCloudParam("Version")
    ...
    /** 初始化密码,需要 base64 编码: false */
    @UCloudParam("Password")
    private String password;

    /** 有此项代表从备份中创建，无代表正常创建: false */
    ...
    /** Master Redis Group的ID，创建只读Slave时，必须填写: false */
