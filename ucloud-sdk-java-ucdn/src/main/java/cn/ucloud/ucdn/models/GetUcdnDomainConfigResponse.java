...
public class GetUcdnDomainConfigResponse extends Response {
    ...
    /** 获取的域名信息，具体参考下面DomainConfig: false */
    ...
    public static class AdvancedConf extends Response {
        ...
        /** http转https回源 true是，false否: false */
    ...
    public static class OriginConf extends Response {
        ...
        /** 源站ip即cdn服务器回源访问的ip地址。多个源站ip，可以这样表述，如：["1.1.1.1","2.2.2.2"]: false */
        @SerializedName("OriginIpList")
        private List<String> originIpList;

        /** 回源Http请求头部Host，默认是加速域名: false */
        ...
        /** 源站协议http，http|https 默认http: false */
        @SerializedName("OriginProtocol")
        private String originProtocol;

        /** 跟随301跳转 0=不跟随 1=跟随: false */
    ...
    public static class CacheConf extends Response {
        ...
        /** 缓存时间的单位。sec（秒），min（分钟），hour（小时），day（天）。上限1年。: false */
        @SerializedName("CacheUnit")
        private String cacheUnit;

        /** 是否缓存，true为缓存，flase为不缓存。为flase的情况下，CacheTTL和CacheUnit强制不生效: false */
        @SerializedName("CacheBehavior")
        private Boolean cacheBehavior;

        /** 状态码模式，非200，206状态码，多个状态码用竖线(|)分隔，该属性仅仅在状态码缓存配置列表中返回: false */
        ...
        /** 是否优先遵循源站头部缓存策略，false为不优先遵循源站，true为优先遵循源站缓存头部。默认为0: false */
    ...
    public static class CacheKeyInfo extends Response {
        ...
        /** 自定义变量,以$符号开头，多个变量用加号(+)连接，$querystring表示所有变量: false */
    ...
    public static class ReferConf extends Response {
        ...
        /** Refer防盗链配置 0白名单，1黑名单: false */
        @SerializedName("ReferType")
        private Integer referType;

        /** ReferType为白名单时（删除），NullRefer为0代表不允许NULL refer访问，为1代表允许Null refer访问: false */
        @SerializedName("NullRefer")
        private Integer nullRefer;

        /** Refer防盗链规则列表，支持正则表达式: false */
    ...
    public static class AccessControlConf extends Response {
        ...
        /** ip黑名单，多个ip，可表示为： IpBlackList.0=1.1.1.1，IpBlackList.1=2.2.2.2: false */
    ...
    public static class DomainConfigInfo extends Response {
        ...
        /** 查询带宽区域 cn代表国内 abroad代表海外 all表示全部区域: false */
        @SerializedName("AreaCode")
        private String areaCode;

        /** 加速域名的业务类型，web代表网站，stream代表视频 ，download 代表下载: false */
         ...
         * enableing代表正在开启加速，disableing代表正在停止加速中，deleteing代表删除中: false
         */
        @SerializedName("Status")
        private String status;

        /** cdn域名。创建加速域名生成的cdn域名，用于设置CNAME记录: false */
        @SerializedName("Cname")
        private String cname;

        /** 域名创建的时间。格式：时间戳: false */
        @SerializedName("CreateTime")
        private Integer createTime;

        /** 测试url。用于域名创建加速时的测试: false */
        @SerializedName("TestUrl")
        private String testUrl;

        /** 国内https状态 enableing-开启中 fail-开启失败 enable-启用 disable-未启用: false */
        @SerializedName("HttpsStatusCn")
        private String httpsStatusCn;

        /** 国外https状态 enableing-开启中 fail-开启失败 enable-启用 disable-未启用: false */
