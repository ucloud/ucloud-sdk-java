...
public class DescribeSelfCommunityImagesResponse extends Response {
    ...
    private List<CompshareImageGroup> imageSetGroup;
    ...
    public List<CompshareImageGroup> getImageSetGroup() {
        return imageSetGroup;
    }

    public void setImageSetGroup(List<CompshareImageGroup> imageSetGroup) {
    ...
    public static class CompshareImageGroup extends Response {
        ...
        /** 镜像数据 */
        @SerializedName("Data")
        private List<CompShareImage> data;
        ...
        public List<CompShareImage> getData() {
            return data;
        }

        public void setData(List<CompShareImage> data) {
            this.data = data;
        }
