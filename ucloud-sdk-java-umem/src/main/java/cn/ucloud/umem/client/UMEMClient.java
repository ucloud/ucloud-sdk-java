...
public interface UMEMClient extends UcloudClient {
        ...
        * @throws Exception
        */
        ModifyUDredisSpaceNameResult modifyUDredisSpaceName(
            ModifyUDredisSpaceNameParam param) throws Exception;
        ...
        * @param asyncFlag 是否异步
        */
        void modifyUDredisSpaceName(ModifyUDredisSpaceNameParam param,
        UcloudHandler<ModifyUDredisSpaceNameResult> handler,
        Boolean... asyncFlag);
        /**
        * 删除高性能umem空间
        *
        ...
        * @throws Exception
        */
        DeleteUDredisSpaceResult deleteUDredisSpace(
            DeleteUDredisSpaceParam param) throws Exception;
        ...
        * @param asyncFlag 是否异步
        */
        void deleteUDredisSpace(DeleteUDredisSpaceParam param,
        UcloudHandler<DeleteUDredisSpaceResult> handler,
        Boolean... asyncFlag);
        /**
        * 获取价格
        *
        ...
        * @throws Exception
        */
        DescribeUDredisUpgradePriceResult describeUDredisUpgradePrice(
            DescribeUDredisUpgradePriceParam param) throws Exception;
        ...
        * @param asyncFlag 是否异步
        */
        void describeUDredisUpgradePrice(DescribeUDredisUpgradePriceParam param,
        UcloudHandler<DescribeUDredisUpgradePriceResult> handler,
        Boolean... asyncFlag);
        /**
        * 获取高性能UMem实例价格信息
        *
        ...
        * @throws Exception
        */
        DescribeUDredisPriceResult describeUDredisPrice(
            DescribeUDredisPriceParam param) throws Exception;
        ...
        * @param asyncFlag 是否异步
        */
        void describeUDredisPrice(DescribeUDredisPriceParam param,
        UcloudHandler<DescribeUDredisPriceResult> handler,
        Boolean... asyncFlag);
        /**
        * 创建高性能umem内存空间
        *
        ...
        * @throws Exception
        */
        CreateUDredisSpaceResult createUDredisSpace(
            CreateUDredisSpaceParam param) throws Exception;
        ...
        * @param asyncFlag 是否异步
        */
        void createUDredisSpace(CreateUDredisSpaceParam param,
        UcloudHandler<CreateUDredisSpaceResult> handler,
        Boolean... asyncFlag);
        /**
        * 获取高性能UMem内存空间列表
        *
        ...
        * @throws Exception
        */
        DescribeUDredisSpaceResult describeUDredisSpace(
            DescribeUDredisSpaceParam param) throws Exception;
        ...
        * @param asyncFlag 是否异步
        */
        void describeUDredisSpace(DescribeUDredisSpaceParam param,
        UcloudHandler<DescribeUDredisSpaceResult> handler,
        Boolean... asyncFlag);
        /**
        * 调整高性能umem容量
        *
        ...
        * @throws Exception
        */
        ResizeUDredisSpaceResult resizeUDredisSpace(
            ResizeUDredisSpaceParam param) throws Exception;
        ...
        * @param asyncFlag 是否异步
        */
        void resizeUDredisSpace(ResizeUDredisSpaceParam param,
        UcloudHandler<ResizeUDredisSpaceResult> handler,
        Boolean... asyncFlag);
        /**
        * 获取uredis升级价格信息
        *
